...
//   const key1 = "7rUGPrSgzy5ce3ra";
//   const key2 = "5352936840690238";

//   final paddedKey1 = _padOrTruncateKey(key1, 32); // Specify the desired key length
//   final paddedKey2 = _padOrTruncateKey(key2, 32); // Specify the desired key length
...
//     // Pad key with itself to reach the desired length
//     final repeatCount = (desiredKeyLength / key.length).ceil();
